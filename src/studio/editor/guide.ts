...
export const HINT = {
  ...
  training:
    'The session boards. Four coned areas at the sizes a session plan is written in: the 40 x 30 small-sided pitch, the same area ruled into six boxes, the 30 x 20 possession grid and the 20 x 20 rondo square. There are deliberately no goals painted on any of them, because a goal in an exercise goes where the exercise wants it: drag mini goals out of Equipment onto the grass around the grid, in the corners, on the ends, facing whichever way you need. Every board leaves about five metres of spare grass round the outside for exactly that, and everything you place lines up with everything else as you drop it.',
  pitchGrid:
