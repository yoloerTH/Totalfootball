...
export function ProfileNudge({
  ...
  return (
    <div
      ...
      className={`fixed bottom-4 right-4 z-[70] w-[min(22rem,calc(100vw-2rem))] rounded-2xl border border-ink-hair bg-surface p-5 shadow-lift transition-all duration-300 ${
